...
🟡 **Planning / BATCH 0 (persistence only).** No application code yet. The implementation backbone is decomposed into 6 phases (P1 all-stub deterministic loop → P6 hardening); each phase is the same loop, runnable and independently verifiable, just progressively more real.
